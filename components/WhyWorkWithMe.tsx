  ...
  return (
    <WorkWithMeContextProvider>
      <Section id="whyWorkWithMe">
        <h2 className="mb-16 text-2xl text-gray-500">
          {/* <Typer
        ...
        <div className="flex gap-20 items-center max-xl:flex-col">
          ...
          <div className="basis-1/2 flex flex-col gap-16">
            <h3 className="text-3xl text-gray-300 leading-normal font-semibold">
              Delivering both <span className="skewtext">hard performing</span>{" "}
              and <span className="skewtext">sales driving</span> apps.
            </h3>
            <WhatIOfferSteps />
          </div>
          {/* right side */}
